    ...
    <form id="ajaxCalendarForm" method="GET" action="{{ route('admin.dashboard') }}" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 12px; border-top: 1px solid #f1f5f9; padding-top: 0.85rem;">
        ...
        <div style="display: flex; align-items: center; gap: 12px; flex-wrap: wrap;">
            ...
            <div style="display: flex; align-items: center; gap: 6px;">
                ...
                <select name="month" class="ajax-cal-select" onchange="triggerCalendarAjax(this);" style="padding: 6px 14px; font-size: 0.82rem; font-weight: 700; border-radius: 8px; border: 1.5px solid #cbd5e1; background: #ffffff; color: #0f172a; cursor: pointer; outline: none;">
            ...
            <div style="display: flex; align-items: center; gap: 6px;">
                ...
                <select name="year" class="ajax-cal-select" onchange="triggerCalendarAjax(this);" style="padding: 6px 14px; font-size: 0.82rem; font-weight: 700; border-radius: 8px; border: 1.5px solid #cbd5e1; background: #ffffff; color: #0f172a; cursor: pointer; outline: none;">
            ...
            <div style="display: flex; align-items: center; gap: 6px;">
                ...
                <input type="date" name="date" value="{{ $selectedDateStr }}" class="ajax-cal-select" onchange="triggerCalendarAjax(this);" style="padding: 5px 12px; font-size: 0.82rem; font-weight: 600; border-radius: 8px; border: 1.5px solid #cbd5e1; background: #ffffff; color: #0f172a; cursor: pointer; outline: none;">
            </div>
        </div>
